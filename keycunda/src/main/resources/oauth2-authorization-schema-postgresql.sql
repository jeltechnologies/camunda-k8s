-- Adapted from the official schema shipped in spring-security-oauth2-authorization-server
-- (org/springframework/security/oauth2/server/authorization/oauth2-authorization-schema.sql):
-- blob -> text and timestamp -> TIMESTAMP WITH TIME ZONE (works on both PostgreSQL and H2,
-- unlike Postgres's "timestamptz" shorthand), per that file's own PostgreSQL note, plus
